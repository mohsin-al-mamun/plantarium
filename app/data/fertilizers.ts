...
export const midData: Fertilizer[] = [
  {
    name: "Epsom Salt", local: "এপসম সল্ট", chemical: "Magnesium Sulfate Heptahydrate (MgSO₄·7H₂O)", symbol: "Mg + S",
  ...
  {
    name: "Gypsum", local: "জিপসাম", chemical: "Calcium Sulfate Dihydrate (CaSO₄·2H₂O)", symbol: "Ca + S",
  ...
  {
    name: "Dolomite / Lime", local: "ডলোমাইট চুন", chemical: "Calcium Magnesium Carbonate (CaMg(CO₃)₂)", symbol: "Ca + Mg",
...
export const bedrockData: Fertilizer[] = [
  ...
  // Held back for later — not removed, just not shown yet.
  // {
